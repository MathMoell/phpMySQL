...
<html lang="en">
  ...
  <body>
    <div class="container">
    <a class="btn btn-warning" href="../logout.php?logout">Tagasi avalehele</a>
    <h1>Administreemimis koht</h1>
    <?php
    ...
    <form action="index.php" method="get">
      ...
      <?php  if(isset($_GET["muuda"]) && isset($_GET["id"])){ ?>
          <input type="submit" value="Salvesta" name="salvesta_muudatus" class="btn btn-secondary"><br>
       <?php  } else { ?>
          <input type="submit" value="Salvesta" name="salvesta" class="btn btn-secondary"><br>
       <?php  }  ?>
    </form>
    <?php
      if(isset($_GET['msg'])){
    ...
    <table class="table table-striped">
      <thead>
        ...
        <th scope="col">id</th>
          ...
          <th scope="col">registreerimis_aeg</th>
      ...
      <tbody>
        <?php  
            ...
            echo 'Leheküljed: '.$lehti_kokku.'<br>';
            echo 'Osavõtja info lehel: '.$uudiseid_lehel.'<br>';
            if (isset($_GET['page'])) {
              $leht = $_GET['page'];
            } else {
              $leht = 1;
            ...
            while($rida = mysqli_fetch_assoc($saada_paring)){
                ...
                echo "<td><a class='btn btn-secondary' href='?muuda&id=".$rida['id']."'>Muuda</a></td>";
