      ...
      echo password_hash('admin', PASSWORD_DEFAULT);
            if (!empty($_POST['user']) && !empty($_POST['password'])) {
                ...
                if ($login == 'admin' && password_verify($str, $s)) {
                    ...
                    echo "Vale username või pwd";
                }
            }
            ?>

        <h2 class="text-center text-dark mt-5">Logi admin lehele</h2>
        <div class="card my-5">
          <form class="card-body cardbody-color p-lg-5" method="post">
            ...
            <div class="text-center"><button type="submit" class="btn btn-color px-5 mb-5 w-100">Logi sisse</button></div>
            <div class="form-group d-md-flex">
                <div class="w-50">
                    <label class="checkbox-wrap checkbox-primary">Ära unusta mind
